...
(function () {
  ...
  const TEXT_FIELDS = ['name','job','appearance','outfit','persona','hobby','rel_bg','taboo','extra','birthday'];
        ...
        <div class="pn-tab-panel" id="pnTp1">
          ...
          <div class="pn-form-group">
            ...
            <div class="pn-form-row">
              ...
              <input class="pn-form-input" type="text" id="pn-f-birthday" placeholder="例：1999-06-15">
            </div>
          </div>
        </div>
        <!-- Tab 2: 關係設定 -->
